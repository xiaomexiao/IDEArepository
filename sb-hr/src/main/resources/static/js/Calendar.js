...
function ShowCalendar(InputBox) {
    ...
    DivContent += "<td style='border-bottom:1px solid #ad8634; background-color:#FAF1C7; font-weight:bold; font-family:Wingdings 2,Wingdings,Webdings; font-size:16px; padding-top:2px; color:#ad8634; cursor:hand' align='center' title='关闭' onClick='javascript:HiddenCalendar()'>S</td>";
    DivContent += "</tr>";
